...
import com.db2020.pj.service.ResponseService.CommonResponse;
...
//	// 단일건 결과를 처리하는 메소드
//	public <T, H> HashResult<T, H> getHashResult(T data) {
//		HashResult<T, H> result = new SingleResult<>();
//		result.setData(data);
//		setSuccessResult(result);
//		return result;
//	}
	...
	// 실패 결과만 처리하는 메소드 (code, msg를 받을 수 있게 커스텀)
